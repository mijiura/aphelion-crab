...
const swItems = [
    ...
    { category: '冒険者技能用アイテム', name: '魔晶石(1点)', price: 100 },
    { category: '冒険者技能用アイテム', name: '魔晶石(2点)', price: 200 },
    { category: '冒険者技能用アイテム', name: '魔晶石(3点)', price: 300 },
    { category: '冒険者技能用アイテム', name: '魔晶石(4点)', price: 400 },
    ...
    { category: '冒険者技能用アイテム', name: 'デーモンブラッド(1点)', price: 100 },
    ...
    { category: 'その他', name: 'オーダーメイド', price: 300 },
    { category: 'その他', name: '銀製武器', price: 1000 },
    { category: 'その他', name: '魔法の武器＋１', price: 5000 },
    { category: 'その他', name: '妖精の武器', price: 1500 },
    { category: 'その他', name: 'イグニタイト加工', price: 5000 },
    { category: 'その他', name: 'アビス強化', price: 2000 },

    { category: 'その他', name: '魔法の鎧＋１', price: 5000 },
    { category: 'その他', name: '防弾加工の鎧', price: 1500 },
    { category: 'その他', name: 'マナタイトの追加装甲', price: 5000 },
