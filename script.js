...
const swItems = [
    ...
    { category: '冒険用具', name: '火縄壺', price: 40 },
    { category: '冒険用具', name: 'ランタン', price: 40 },

    { category: '冒険用具', name: 'ロープ(10m)', price: 10 },
    { category: '冒険用具', name: 'くさび(10本)', price: 20 },
    { category: '冒険用具', name: 'バランスのよい小型ハンマー', price: 10 },
    { category: '冒険用具', name: 'くさび', price: 20 },
    { category: '冒険用具', name: '小型ナイフ', price: 20 },
    { category: '冒険用具', name: '手鏡', price: 50 },

    { category: '冒険用具', name: '着替えセット', price: 10 },
    { category: '冒険用具', name: '水着', price: 20 },
    { category: '冒険用具', name: '千変万化の衣', price: 18000 },

    { category: '冒険用具', name: 'ロバ', price: 800 },
    { category: '冒険用具', name: 'ラバ', price: 1000 },
    { category: '冒険用具', name: '荷馬', price: 1500 },
    { category: '冒険用具', name: 'ラクダ', price: 2000 },

    { category: '冒険用具', name: '羽根ペン', price: 2 },
    { category: '冒険用具', name: 'インク', price: 40 },
    { category: '冒険用具', name: '絵筆', price: 5 },
    { category: '冒険用具', name: '油絵の具', price: 10 },
    { category: '冒険用具', name: '羊皮紙(5枚)', price: 5 },
    { category: '冒険用具', name: '白紙の本(20頁)', price: 30 },
    { category: '冒険用具', name: '砂時計(3分)', price: 120 },
    { category: '冒険用具', name: '虫眼鏡', price: 100 },
    { category: '冒険用具', name: 'ティーセット', price: 100 },
    { category: '冒険用具', name: '化粧品セット', price: 100 },
    ...
    { category: '魔法・魔晶石', name: '我慢比べのワンド', price: 700 },
    { category: '魔法・魔晶石', name: '測量のワンド', price: 4200 },
    { category: '魔法・魔晶石', name: 'ミニマムアーマー(防護点3)', price: 2120 },
    { category: '魔法・魔晶石', name: 'ミニマムアーマー(防護点6)', price: 6120 },
    { category: '魔法・魔晶石', name: '魔力を帯びた骨', price: 500 },
    { category: '魔法・魔晶石', name: '呼応石', price: 100 },
    { category: '魔法・魔晶石', name: '携帯神殿', price: 9120 },
    { category: '魔法・魔晶石', name: '浄化の聖印', price: 13800 },
    { category: '魔法・魔晶石', name: '妖精使いの宝石', price: 50 },
    { category: '魔法・魔晶石', name: '宝石ケース', price: 100 },
    { category: '魔法・魔晶石', name: '華美なる宝石飾り(名誉20)', price: 200 },
    { category: '魔法・魔晶石', name: 'フェアリードロップ', price: 1000 },
    ...
    { category: '魔法・魔晶石', name: '魔晶石(10点)', price: 2000 },
    { category: '魔法・魔晶石', name: 'マナチャージクリスタル(1点)', price: 500 },
    { category: '魔法・魔晶石', name: 'マナチャージクリスタル(2点)', price: 1000 },
    { category: '魔法・魔晶石', name: 'マナチャージクリスタル(3点)', price: 1500 },
    { category: '魔法・魔晶石', name: 'マナチャージクリスタル(4点)', price: 2000 },
    { category: '魔法・魔晶石', name: 'マナチャージクリスタル(5点)', price: 2500 },
    { category: '魔法・魔晶石', name: 'アルケミーキット', price: 200 },
    { category: '魔法・魔晶石', name: 'マテリアルカード(B)', price: 20 },
    { category: '魔法・魔晶石', name: 'マテリアルカード(A)', price: 200 },
    { category: '魔法・魔晶石', name: 'マテリアルカード(S)', price: 2000 },
    { category: '魔法・魔晶石', name: 'マテリアルカード(SS)', price: 20000 },
    { category: '魔法・魔晶石', name: 'デーモンブラッド(1点)', price: 100 },
    { category: '魔法・魔晶石', name: '矢筒', price: 20 },
    { category: '魔法・魔晶石', name: '補充の矢筒', price: 600 },
    { category: '魔法・魔晶石', name: 'えびら', price: 100 },
    { category: '魔法・魔晶石', name: 'ガンベルト', price: 100 },
    { category: '魔法・魔晶石', name: 'バレットスリンガー', price: 40 },
    { category: '魔法・魔晶石', name: 'バレットポーチ', price: 100 },
    { category: '魔法・魔晶石', name: 'スカウト用ツール', price: 100 },
    { category: '魔法・魔晶石', name: '精密ツールセット', price: 2500 },
    { category: '魔法・魔晶石', name: '機械仕掛けの指', price: 7080 },
    { category: '魔法・魔晶石', name: 'アンロックキー', price: 100 },
    { category: '魔法・魔晶石', name: '薬師道具セット', price: 200 },
    { category: '魔法・魔晶石', name: '魔香のパイプ', price: 1360 },
    { category: '魔法・魔晶石', name: '楽器', price: 100 },
    { category: '魔法・魔晶石', name: '明音のフルート', price: 200 },
    { category: '魔法・魔晶石', name: 'ペット', price: 100 },
    { category: '魔法・魔晶石', name: '尊い騎手の像(名誉50)', price: 1000 },
    { category: '魔法・魔晶石', name: 'アルケミーキット', price: 200 },
    { category: '魔法・魔晶石', name: 'カードシューター', price: 1500 },
    ...
    { category: '装飾品', name: 'スマルティエの増強の指輪', price: 20 },
...
// 例: ['すべて', '冒険用具', '薬品', '武具', ...]
// [学習用メモ]
// - map(): 配列の中身を1つずつ加工して新しい配列を作るメソッドです。ここでは `{ category: '冒険用具', name... }` から `'冒険用具'` だけを取り出しています。
